...
public class Contants {
    ...
    //数据库名称
    public static final String GENERATE_DATABASENAME = "example";

    public static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    public static final String DB_ENCODING = "utf-8";
    public static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/" + GENERATE_DATABASENAME + "?useUnicode=true&characterEncoding=" + DB_ENCODING;
    ...
    //id名称
    public static final String GENERATE_ID_TYPE = "Integer";
